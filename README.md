...
Windows ARM64, Windows ARM64-hosted x64, and macOS ARM64 runners. Intel macOS
is intentionally excluded. The pgrx pg_test and pglogical integration jobs
install the fork release package or source release for each target.
